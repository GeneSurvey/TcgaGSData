...
A2ML1|144568
*/
public class GN_RNASeqV2 extends GeneNames_Mixin
{
	public GN_RNASeqV2(HashMap<String, Integer> theGeneEq, String theIdPath) throws IOException, Exception
	{
		super(theGeneEq, theIdPath, "RNASeqV2");
	}
