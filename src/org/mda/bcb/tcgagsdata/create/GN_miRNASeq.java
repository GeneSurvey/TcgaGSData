...
hsa-mir-1180
*/
public class GN_miRNASeq extends GeneNames_Mixin
{
	public GN_miRNASeq(HashMap<String, Integer> theGeneEq, String theIdPath) throws IOException, Exception
	{
		super(theGeneEq, theIdPath, "miRNASeq");
	}
